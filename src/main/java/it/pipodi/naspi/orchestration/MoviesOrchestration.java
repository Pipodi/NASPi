...
import it.pipodi.naspi.model.Movie;
...
@Service
public class MoviesOrchestration {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MoviesOrchestration.class);
    ...
    public Movies getMoviesList() {
        logger.info("getMoviesList() method called");
        String moviesFolder = String.format("%s/%s", config.getRootFolder(), "Movies");
        try {
            Movies movies = new Movies();
            List<Movie> moviesList = new ArrayList<>();
            Stream<Path> walk = Files.walk(Paths.get(moviesFolder));
            ...
            for (File file : files) {
                ...
                movie.setName(parseName(file.getName()));
    ...
    public Resource downloadFile(String fileName) {
        ...
        return fileManagerService.loadFileAsResource(fileName, "Movies");
    }
    ...
    public UploadResponse uploadFile(MultipartFile file) {
        ...
        this.fileManagerService.uploadFile(file, "Movies");
